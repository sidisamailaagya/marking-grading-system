...
<head>
  ...
  <style>
    ...
    .item{ border:1px solid #edf2f7; border-radius:12px; padding:.75rem; }
    .muted{ color:#718096; font-size:.9rem; }
    .badge{ padding:.18rem .5rem; border-radius:999px; font-weight:800; font-size:.75rem; display:inline-block; }
    .badge.info{ background:rgba(66,153,225,.12); color:#2b6cb0; }
    .badge.tip{ background:rgba(72,187,120,.12); color:#2f855a; }
...
<body>
    ...
    <div class="navbar-wrapper">
      <div class="navbar-content scroll-div">
        <ul class="nav pcoded-inner-navbar">
          ...
          <li class="nav-item"><a href="feedback-comments.php" class="nav-link active"><span class="pcoded-micon"><i class="fas fa-comments"></i></span><span class="pcoded-mtext">Feedback & Comments</span></a></li>
  ...
  <script>
    const lecturerRemarks = [
      { course:'CS201', by:'Dr. Johnson', date:'Sep 15, 2025', text:'Great effort on the recent project. Keep refining your code quality.' },
      { course:'MATH201', by:'Dr. Lee', date:'Sep 10, 2025', text:'Practice more on integration techniques to improve speed.' },
    ];
    ...
    function render(){
      const l = document.getElementById('lecturerList'); l.innerHTML='';
      ...
      const t = document.getElementById('tipsList'); t.innerHTML='';
